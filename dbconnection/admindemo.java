...
public class admindemo extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String s1=jTextField3.getText();//title
        String s2=jTextField4.getText();//id
        int i=Integer.parseInt(s2);
        String s3=jTextField5.getText();//author
        String s4=jTextField6.getText();//price
        double d=Double.parseDouble(s4);
        String s5=jTextField7.getText();//qty
        int j=Integer.parseInt(s5);
        try {
            Connection c;
            c = DriverManager.getConnection("jdbc:derby://localhost:1527/ebookshop");
            Statement st=c.createStatement();
            st.executeUpdate("insert into books values("+i+",'"+s1+"','"+s3+"',"+d+","+j+")");
            select();
